...
public class DesUtil {
	private static final String Algorithm = "DES"; // 瀹氫箟 鍔犲瘑绠楁硶,鍙敤
	...
	public static void main(String[] args) {
		...
		String jdbcDriverClassName = Encrypt(driverClass, hex2byte(key));// 鍔犲瘑
		String jdbcUrl = Encrypt(url, hex2byte(key));// 鍔犲瘑
		String jdbcUsername = Encrypt(userName, hex2byte(key));// 鍔犲瘑
		String jdbcPassword = Encrypt(userPassword, hex2byte(key));// 鍔犲瘑
