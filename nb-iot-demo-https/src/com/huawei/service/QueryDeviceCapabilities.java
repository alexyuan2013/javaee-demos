...
public class QueryDeviceCapabilities {
	...
	public static void main(String args[]) throws Exception {
        ...
        String urlQueryDeviceCapabilities = "https://183.1.8.114:8743/iocm/app/data/v1.1.0/deviceCapabilities";  //please replace the IP and Port, when you use the demo.
        ...
        System.out.println(bodyQueryDeviceCapabilities);
    }	
